...
) : PagedListAdapter<UiComicStrip, ComicsAdapter.ViewHolder>(DiffCallback()),
    ListPreloader.PreloadModelProvider<UiComicStrip> {

    var actionListener: ComicsAdapterActionListener? = null
        ...
        holder.run {
            ...
            favouriteImageView.apply {
                ...
                setOnClickListener {
                    ...
                    actionListener?.onItemFavouriteToggled(
                        comicStrip.number,
                        isFavourite
                    )
                }
            ...
            comicImageView.setOnClickListener { view ->
                actionListener?.onImageClicked(view, comicStrip.imageLink)
            }
        }
    }
